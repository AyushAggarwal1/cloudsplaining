...
cloudsplaining.add_command(command.scan_cloud.scan_cloud)
cloudsplaining.add_command(command.collect_cloud.collect_cloud)
cloudsplaining.add_command(command.access_map_cloud.access_map_cloud)
